...
\caption{Panel de monitoreo de T-Pot mostrando ataques en tiempo real}
\label{fig:ataques}
\end{figure}
...
La Figura 2 presenta un gr\'afico del n\'umero total de ataques realizados contra la m\'aquina de pruebas durante el periodo de monitoreo. Se observa un incremento significativo en la cantidad de eventos maliciosos detectados, lo que demuestra la capacidad de T-Pot para capturar y registrar m\'ultiples tipos de amenazas simult\'aneamente.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\columnwidth]{img/Nataques.jpeg}
\caption{N\'umero de ataques realizados contra la m\'aquina de pruebas}
\label{fig:nataques}
\end{figure}
